...
```
phoneinfoga scan -n "+919741307505 "
phoneinfoga scan -n "+919741307505 "
phoneinfoga scan -n "9741307505 "
```

Special chars such as `( ) - +` will be escaped so typing US-based numbers stay easy : 

```
phoneinfoga scan -n "+919741307505 q"
```
...
```
phoneinfoga scan -n +919741307505 -s footprints
```
...
```
phoneinfoga recon -n +919741307505 
```
-->
